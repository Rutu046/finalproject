        ...
        <div class="card1">
          <div class="card-body1">
            ...
            <div class="btn-group1">
              <button class="btn-primary1" onclick="showSubscriptionButtons()">Journal Subscription</button><br><br>
              <button class="btn-primary1" onclick="showSubscriptionButtons()">Academic Subscription</button><br><br>
